...
double potential_and_jacobian(const double *xx, double *grad, const double *orig, const double *cost_mat, const double *theta, const size_t nn, const size_t mm, double *wksp)
{
